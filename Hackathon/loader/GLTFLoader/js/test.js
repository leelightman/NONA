...
function createCarousel(){
  ...
  //renderer1 = createItem(true,"models/chair/scene.gltf");
  //carousel_inner.appendChild(renderer1);
  renderer2 = createItem(true,"models/chair.glb");
  carousel_inner.appendChild(renderer2);
