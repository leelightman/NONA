...
$(document).ready(function() {
  ...
  function insertResponseMessage(content) {
    $(
      '<div class="message loading new"><figure class="avatar"><img src="./components/img/bot.png" /></figure><span></span></div>'
    ).appendTo($(".mCSB_container"));

    setTimeout(function() {
      $(".message.loading").remove();
      $(
        '<div class="message new"><figure class="avatar"><img src="./components/img/bot.png" /></figure>' +
          content +
          "</div>"
      )
        .appendTo($(".mCSB_container"))
